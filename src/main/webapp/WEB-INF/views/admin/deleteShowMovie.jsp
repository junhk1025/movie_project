	...
	<div class="content">
		<nav id="navLeft">
			<ul>
				...
				<li class="active"><a href="#">상영 영화 삭제</a></li>
			</ul>
		</nav>
				...
				<div class="areaSpot">
					<div class="area">
						<ul>
							...
							<li class="areaLi"><a href="#">서울(23)</a><span class="check"><i
		...
		<div class="day_select">
			<div class="group_top">
				<h4 class="movie_day">2020-03-10(화)</h4>
			</div>
...
<script>
                        ...
                        spotLi.click(function() {
                                ...
                                if ($(this).hasClass("spot_active")) {
                                        $(this)
                                                .children("a")
                                                .removeClass("spot_active");
                                } else {
                                        $(this)
                                                .children("a")
                                                .addClass("spot_active");
                                }
                        });
                        ...
                        $(function() {
                                ...
                                $("#demo-one-week")
                                        ...
                                        .calendar({
                                                ...
                                                weeks: 1 // More info about weeks: https://docs.mobiscroll.com/4-10-3/calendar#opt-weeks
                                        });
                        });
