...
;(function(window) {
	...
	var support = {transitions : Modernizr.csstransitions},
		...
		// main container
		container = document.querySelector('.cube_box'),
	...
	window.addEventListener( 'message', function( e ) {
      ...
      if(count>limit){
         ...
         count--;
         var seatList = document.getElementsByClassName("row__seat--selected");
         seatList[seatList.length-1].className = "row__seat tooltip";
         //classie.remove(seatList, 'row__seat--selected');
